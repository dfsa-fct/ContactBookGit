...
public class Main {
    ...
    public static final String PHONES_DIFFERENT = "All contacts have different phone numbers.";
    public static final String PHONES_EQUAL = "There are contacts that share phone numbers.";
    ...
    private static void checkEqualPhones(ContactBook cBook) {
        if (cBook.hasEqualPhones()) {
            System.out.println(PHONES_EQUAL);
        }
        else System.out.println(PHONES_DIFFERENT);
    }
}
